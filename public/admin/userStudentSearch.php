...
<head>
	<?php 
		include("head.html");
	?>
	<title>Manage Student | Admin | UReCo</title>
        ...
        function FetchBlock(id){
			...
			function DeleteStud(id){
				if(confirm('Are you sure?')){
					location = 'userStudentDelete.php?matrixNo='+id;
				}
			}
    </script>
</head>
	...
	<div class="py-4">
		<div class="d-flex flex-column " id="content">
			...
			<div class="d-flex">
				...
				<div class="p-2">
					<button type="button" class="btn btn-primary" id="add-btn" onclick="location.href='userStudentAdd.php'">Add New Student</button>
				</div>
			</div>
			...
			<div class="d-flex flex-column rounded p-4 mb-3 bg-color">
               ...
               <h3 >Search for student</h3>
				...
				<form action="userStudentSearch.php" name="stud_search" method="POST">
						...
						<?php
							...
							?>
										<tr>
											...
											<td><input type="button" name="add" class="btn btn-warning" value="Update" onclick="location.href='userStudentUpdate.php?matrixNo=<?php echo $row1['matrixNo']; ?>'"></td>
											<td><input type="button" name="add" class="btn btn-warning" value="Delete" onclick="DeleteStud('<?php echo $row1['matrixNo']; ?>')"></td>
										</tr>
							<?php
									}
								}
