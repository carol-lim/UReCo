...
<head>
	...
	<title>Closed Helpdesk | Staff | UReCo</title>
			...
			<div class="rounded p-4 bg-color">
				<div class="table-responsive">  
					<table id="helpdesk_closed" class="table table-striped table-bordered dt-responsive wrap" style="width:100%">  
						...
						<tbody>  
						<?php  
				$query = mysqli_query($conn, "SELECT helpdesk.*, category.categoryName, subcategory.scName FROM helpdesk JOIN category ON helpdesk.category = category.categoryID JOIN subcategory ON helpdesk.subcategory = subcategory.scID WHERE closeDate IS NOT NULL"); 
