...
<head>
	...
	<title>Announcement Detail | Staff | UReCo</title>
		...
		<div class="d-flex flex-column " id="content">
			...
			<div class="d-flex">
				...
				<div class="p-2">
					...
					<button type="button" class="btn btn-primary" id="edit-btn" onclick="location.href='annEdit.php?id=<?php echo $annid ?>'">Edit</button>
				</div>
			</div>
